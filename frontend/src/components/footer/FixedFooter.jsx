                ...
                <div className="container text-center">
                    <div className="row align-items-start">
                        <div className="col">
                            ...
                            <div className="mb-3">
                                <p className="text">
                                    this app is developed using Java Spring Boot & React, 
                                    source code available on : <a rel="noopener noreferrer" className="link" href="https://github.com/devloker/booksLib" target="_blank">GitHub</a>
                                </p>
                            </div>
                        </div>
                        <div className="col">
